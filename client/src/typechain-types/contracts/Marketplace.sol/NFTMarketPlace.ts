...
export interface NFTMarketPlaceInterface extends utils.Interface {
  functions: {
    ...
    "getTotalListingItems()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getTotalListingItems",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface NFTMarketPlace extends BaseContract {
  ...
  functions: {
    ...
    getTotalListingItems(overrides?: CallOverrides): Promise<[BigNumber]>;
